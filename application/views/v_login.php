...
<html lang="en">
  ...
  <body class="d-flex justify-content-center align-items-center" style="background-image: url(image\ 2.png); background-repeat: no-repeat; background-position: center; background-size: cover">
      ...
      <div class="card-body">
        <form>
          ...
          <div class="d-flex align-items-center justify-content-center mt-4 mb-0 btnlogin">
            <a class="btn  btn-primary btncustom text-white w-100" href="index.php" >Login</a>
          </div>
        </form>
      </div>
    </div>
