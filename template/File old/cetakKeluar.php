    ...
    <div class="container d-flex justify-content-between " style="margin-top: 5rem;">
      <div class="section text-light " style="width: 63.7%">
        <table class="table table-borderless text-center">
          <tbody>
            <?php
            $query2 = mysqli_query($koneksi, "SELECT * FROM tb_barang_keluar JOIN tb_unit ON tb_unit.id_unit = tb_barang_keluar.id_unit JOIN barang ON barang.id_barang = tb_barang_keluar.id_barang WHERE tgl_barang_keluar >= '$tanggal_awal' AND tgl_barang_keluar <= '$tanggal_akhir' AND tb_barang_keluar.id_unit = '$id_unit'");
            $no = 1;
      ...
      <div class="section text-light " style="width: 37.3%">
        <table class="table table-borderless text-center">
          ...
          <tbody>
            <?php
            $query3 = mysqli_query($koneksi, "SELECT * FROM tb_barang_keluar JOIN tb_unit ON tb_unit.id_unit = tb_barang_keluar.id_unit JOIN barang ON barang.id_barang = tb_barang_keluar.id_barang WHERE tgl_barang_keluar >= '$tanggal_awal' AND tgl_barang_keluar <= '$tanggal_akhir' AND tb_barang_keluar.id_unit = '$id_unit'");
            $total = 0;
